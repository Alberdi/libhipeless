...
__kernel void function(int left, int upper, int nota, int unit, int row, int dim, int m, int n,
                       number alpha, __global const number *a, __global const number *b, __global number *c) {
