...
// C = alpha * A * B + beta * C
// Double precission
void blas_dgemm(cl_char transa, cl_char transb, cl_int m, cl_int  n,  cl_int  k, cl_double alpha, cl_double *a,
...
void blas_sgemm(cl_char transa, cl_char transb, cl_int m, cl_int  n,  cl_int  k, cl_float alpha, cl_float *a,
